...
static void event_handler_cb_menu_1_obj15(lv_event_t *e) {
    lv_event_code_t event = lv_event_get_code(e);
    void *flowState = e->user_data;
...
static void event_handler_cb_setting_1_obj16(lv_event_t *e) {
    lv_event_code_t event = lv_event_get_code(e);
    void *flowState = e->user_data;
    if (event == LV_EVENT_PRESSED) {
        flowPropagateValue(flowState, 0, 0);
...
static void event_handler_cb_setting_1_obj22(lv_event_t *e) {
    lv_event_code_t event = lv_event_get_code(e);
    void *flowState = e->user_data;
    if (event == LV_EVENT_PRESSED) {
...
static void event_handler_cb_audioo_1_obj24(lv_event_t *e) {
    lv_event_code_t event = lv_event_get_code(e);
    void *flowState = e->user_data;
    if (event == LV_EVENT_PRESSED) {
        flowPropagateValue(flowState, 0, 0);
...
static void event_handler_cb_alarm_1_obj26(lv_event_t *e) {
    lv_event_code_t event = lv_event_get_code(e);
    void *flowState = e->user_data;
    if (event == LV_EVENT_PRESSED) {
        flowPropagateValue(flowState, 0, 0);
...
static void event_handler_cb_date_time_obj28(lv_event_t *e) {
    lv_event_code_t event = lv_event_get_code(e);
    void *flowState = e->user_data;
    if (event == LV_EVENT_PRESSED) {
        flowPropagateValue(flowState, 0, 0);
...
static void event_handler_cb_hasilhidrasi_obj32(lv_event_t *e) {
    lv_event_code_t event = lv_event_get_code(e);
    void *flowState = e->user_data;
    if (event == LV_EVENT_PRESSED) {
        flowPropagateValue(flowState, 0, 0);
...
static void event_handler_cb_sub_mneu_dsiplay_1_obj35(lv_event_t *e) {
    lv_event_code_t event = lv_event_get_code(e);
    void *flowState = e->user_data;
...
static void event_handler_cb_sub_mneu_dsiplay_1_obj36(lv_event_t *e) {
    lv_event_code_t event = lv_event_get_code(e);
    void *flowState = e->user_data;
    if (event == LV_EVENT_PRESSED) {
        flowPropagateValue(flowState, 15, 0);
...
static void event_handler_cb_healty_1_obj38(lv_event_t *e) {
    lv_event_code_t event = lv_event_get_code(e);
    void *flowState = e->user_data;
    if (event == LV_EVENT_PRESSED) {
        flowPropagateValue(flowState, 0, 0);
...
static void event_handler_cb_healty_1_obj40(lv_event_t *e) {
    lv_event_code_t event = lv_event_get_code(e);
    void *flowState = e->user_data;
    if (event == LV_EVENT_PRESSED) {
...
static void event_handler_cb_healty_2_obj41(lv_event_t *e) {
    lv_event_code_t event = lv_event_get_code(e);
    void *flowState = e->user_data;
    if (event == LV_EVENT_PRESSED) {
        flowPropagateValue(flowState, 0, 0);
...
static void event_handler_cb_healty_2_obj43(lv_event_t *e) {
    lv_event_code_t event = lv_event_get_code(e);
    void *flowState = e->user_data;
    if (event == LV_EVENT_PRESSED) {
        flowPropagateValue(flowState, 4, 0);
...
static void event_handler_cb_header_info_obj11(lv_event_t *e) {
    lv_event_code_t event = lv_event_get_code(e);
    void *flowState = e->user_data;
}
...
void create_screen_main() {
    ...
    apply_style_submenu(obj);
    {
        ...
        }
        {
            ...
            create_user_widget_header_info(obj, getFlowState(flowState, 12), 78);
            lv_obj_clear_flag(obj, LV_OBJ_FLAG_SCROLLABLE);
        }
    }
}
...
void tick_screen_main() {
    ...
    tick_user_widget_header_info(getFlowState(flowState, 12), 78);
}
...
void create_screen_menu_1() {
    ...
    apply_style_submenu(obj);
    {
        lv_obj_t *parent_obj = obj;
        {
            ...
            lv_obj_set_size(obj, 368, 448);
            lv_obj_add_event_cb(obj, event_handler_cb_menu_1_obj15, LV_EVENT_ALL, flowState);
            lv_obj_add_flag(obj, LV_OBJ_FLAG_ADV_HITTEST);
            lv_obj_clear_flag(obj, LV_OBJ_FLAG_SCROLLABLE);
            lv_obj_set_style_arc_img_src(obj, &img_background1, LV_PART_MAIN | LV_STATE_DEFAULT);
            lv_obj_set_style_bg_img_src(obj, &img_background1, LV_PART_MAIN | LV_STATE_DEFAULT);
...
void create_screen_setting_1() {
    ...
    apply_style_submenu(obj);
    {
        lv_obj_t *parent_obj = obj;
        {
            ...
            lv_obj_add_event_cb(obj, event_handler_cb_setting_1_obj16, LV_EVENT_ALL, flowState);
            lv_obj_add_flag(obj, LV_OBJ_FLAG_SCROLL_ON_FOCUS);
            lv_obj_clear_flag(obj, LV_OBJ_FLAG_SCROLLABLE);
            apply_style_buttonback(obj);
            {
        ...
        }
        {
            ...
            lv_obj_set_style_bg_opa(obj, 155, LV_PART_MAIN | LV_STATE_DEFAULT);
            {
                lv_obj_t *parent_obj = obj;
                {
                    ...
                    lv_obj_add_event_cb(obj, event_handler_cb_setting_1_obj22, LV_EVENT_ALL, flowState);
                }
                {
                    lv_obj_t *obj = lv_label_create(parent_obj);
                    objects.obj23 = obj;
...
void create_screen_audioo_1() {
    ...
    apply_style_submenu(obj);
    {
        lv_obj_t *parent_obj = obj;
        {
            ...
            lv_obj_add_event_cb(obj, event_handler_cb_audioo_1_obj24, LV_EVENT_ALL, flowState);
            lv_obj_add_flag(obj, LV_OBJ_FLAG_SCROLL_ON_FOCUS);
            lv_obj_clear_flag(obj, LV_OBJ_FLAG_SCROLLABLE);
            apply_style_buttonback(obj);
            {
...
void create_screen_alarm_1() {
    ...
    apply_style_submenu(obj);
    {
        lv_obj_t *parent_obj = obj;
        {
            ...
            lv_obj_set_size(obj, 67, 73);
            lv_obj_add_event_cb(obj, event_handler_cb_alarm_1_obj26, LV_EVENT_ALL, flowState);
            lv_obj_add_flag(obj, LV_OBJ_FLAG_SCROLL_ON_FOCUS);
            lv_obj_clear_flag(obj, LV_OBJ_FLAG_SCROLLABLE);
            apply_style_buttonback(obj);
            {
...
void create_screen_date_time() {
    ...
    apply_style_submenu(obj);
    {
        lv_obj_t *parent_obj = obj;
        {
            ...
            lv_obj_add_event_cb(obj, event_handler_cb_date_time_obj28, LV_EVENT_ALL, flowState);
            apply_style_panel_transparan(obj);
            {
                lv_obj_t *parent_obj = obj;
                {
...
void create_screen_hasilhidrasi() {
    ...
    apply_style_submenu(obj);
    {
        lv_obj_t *parent_obj = obj;
        {
            ...
            lv_obj_add_event_cb(obj, event_handler_cb_hasilhidrasi_obj32, LV_EVENT_ALL, flowState);
            lv_obj_add_flag(obj, LV_OBJ_FLAG_SCROLL_ON_FOCUS);
            lv_obj_clear_flag(obj, LV_OBJ_FLAG_SCROLLABLE);
            apply_style_buttonback(obj);
            {
...
void create_screen_sub_mneu_dsiplay_1() {
    ...
    apply_style_submenu(obj);
    {
        ...
        }
        {
            ...
            lv_obj_set_style_bg_color(obj, lv_color_hex(0xff414446), LV_PART_MAIN | LV_STATE_DEFAULT);
            {
                ...
                }
                {
                    ...
                    lv_obj_add_event_cb(obj, event_handler_cb_sub_mneu_dsiplay_1_obj35, LV_EVENT_ALL, flowState);
                    lv_obj_set_style_bg_opa(obj, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
                    lv_obj_set_style_border_side(obj, LV_BORDER_SIDE_NONE, LV_PART_MAIN | LV_STATE_DEFAULT);
                    lv_obj_set_style_shadow_opa(obj, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
                    lv_obj_set_style_text_color(obj, lv_color_hex(0xfff1f2ed), LV_PART_MAIN | LV_STATE_DEFAULT);
        ...
        }
        {
            ...
            apply_style_buton_ssubmenu(obj);
            {
                lv_obj_t *parent_obj = obj;
                {
                    ...
                    lv_obj_clear_flag(obj, LV_OBJ_FLAG_SCROLLABLE);
                    apply_style_iconimage(obj);
                    lv_obj_set_style_bg_img_src(obj, &img_time_sleepp, LV_PART_MAIN | LV_STATE_DEFAULT);
                }
                {
                    lv_obj_t *obj = lv_label_create(parent_obj);
        ...
        }
        {
            ...
            apply_style_buton_ssubmenu(obj);
            {
                lv_obj_t *parent_obj = obj;
                {
                    ...
                    lv_obj_clear_flag(obj, LV_OBJ_FLAG_SCROLLABLE);
                    apply_style_iconimage(obj);
                    lv_obj_set_style_bg_img_src(obj, &img_lock_theme, LV_PART_MAIN | LV_STATE_DEFAULT);
                }
                {
                    lv_obj_t *obj = lv_label_create(parent_obj);
        ...
        }
        {
            ...
            lv_obj_set_size(obj, 78, 73);
            lv_obj_add_event_cb(obj, event_handler_cb_sub_mneu_dsiplay_1_obj36, LV_EVENT_ALL, flowState);
            lv_obj_add_flag(obj, LV_OBJ_FLAG_SCROLL_ON_FOCUS);
            lv_obj_clear_flag(obj, LV_OBJ_FLAG_SCROLLABLE);
            apply_style_buttonback(obj);
            {
...
void tick_screen_sub_mneu_dsiplay_1() {
    ...
    }
    {
        ...
        int32_t cur_val = lv_dropdown_get_selected(objects.obj35);
        if (new_val != cur_val) {
            tick_value_change_obj = objects.obj35;
            lv_dropdown_set_selected(objects.obj35, new_val);
            tick_value_change_obj = NULL;
        }
    }
    {
...
void create_screen_healty_1() {
    ...
    apply_style_submenu(obj);
    {
        lv_obj_t *parent_obj = obj;
        {
            ...
            lv_obj_add_event_cb(obj, event_handler_cb_healty_1_obj38, LV_EVENT_ALL, flowState);
            lv_obj_add_flag(obj, LV_OBJ_FLAG_SCROLL_ON_FOCUS);
            lv_obj_clear_flag(obj, LV_OBJ_FLAG_SCROLLABLE);
            apply_style_buttonback(obj);
            {
        ...
        }
        {
            ...
            lv_obj_set_style_bg_opa(obj, 155, LV_PART_MAIN | LV_STATE_DEFAULT);
            {
                ...
                }
                {
                    ...
                    lv_obj_add_event_cb(obj, event_handler_cb_healty_1_obj40, LV_EVENT_ALL, flowState);
...
void create_screen_healty_2() {
    ...
    lv_obj_set_style_bg_color(obj, lv_color_hex(0xff070707), LV_PART_MAIN | LV_STATE_DEFAULT);
    {
        lv_obj_t *parent_obj = obj;
        {
            ...
            lv_obj_add_event_cb(obj, event_handler_cb_healty_2_obj41, LV_EVENT_ALL, flowState);
            lv_obj_add_flag(obj, LV_OBJ_FLAG_SCROLL_ON_FOCUS);
            lv_obj_clear_flag(obj, LV_OBJ_FLAG_SCROLLABLE);
            apply_style_buttonback(obj);
            {
        ...
        }
        {
            ...
            lv_obj_add_event_cb(obj, event_handler_cb_healty_2_obj43, LV_EVENT_ALL, flowState);
            lv_obj_add_flag(obj, LV_OBJ_FLAG_SCROLL_ON_FOCUS);
                ...
                lv_obj_t *parent_obj = obj;
                {
                    ...
                    apply_style_panel_transparan(obj);
                    {
                        ...
                        }
                        {
                            ...
                            lv_obj_add_event_cb(obj, event_handler_cb_header_info_obj11, LV_EVENT_ALL, flowState);
